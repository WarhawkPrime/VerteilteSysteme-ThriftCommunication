...
namespace Thrift {
    ...
    typedef struct _SensorDataMessage__isset {
        _SensorDataMessage__isset() : newestTempData(false), newestWindData(false), newestHumidityData(false), newestBrightnessData(false) {}
        bool newestTempData : 1;
        bool newestWindData : 1;
        bool newestHumidityData : 1;
        bool newestBrightnessData : 1;
    } _SensorDataMessage__isset;

    class SensorDataMessage : public virtual ::apache::thrift::TBase {
    public:

        SensorDataMessage(const SensorDataMessage&);
        SensorDataMessage& operator=(const SensorDataMessage&);
        SensorDataMessage() : newestTempData(), newestWindData(), newestHumidityData(), newestBrightnessData() {
        }

        virtual ~SensorDataMessage() noexcept;
        std::string newestTempData;
        std::string newestWindData;
        std::string newestHumidityData;
        std::string newestBrightnessData;

        _SensorDataMessage__isset __isset;
        ...
        bool operator == (const SensorDataMessage& rhs) const
        {
        ...
        bool operator < (const SensorDataMessage&) const;
