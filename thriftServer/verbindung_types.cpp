...
namespace Thrift {
    ...
    SensorDataMessage::~SensorDataMessage() noexcept {
    }


    void SensorDataMessage::__set_newestTempData(const std::string& val) {
        this->newestTempData = val;
    }

    void SensorDataMessage::__set_newestWindData(const std::string& val) {
        this->newestWindData = val;
    }

    void SensorDataMessage::__set_newestHumidityData(const std::string& val) {
        this->newestHumidityData = val;
    }

    void SensorDataMessage::__set_newestBrightnessData(const std::string& val) {
        this->newestBrightnessData = val;
    }
    std::ostream& operator<<(std::ostream& out, const SensorDataMessage& obj)
    {
        obj.printTo(out);
        return out;
    }
    ...
    uint32_t SensorDataMessage::read(::apache::thrift::protocol::TProtocol* iprot) {
    ...
    uint32_t SensorDataMessage::write(::apache::thrift::protocol::TProtocol* oprot) const {
        uint32_t xfer = 0;
        ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
        xfer += oprot->writeStructBegin("SensorDataMessage");
    ...
    void swap(SensorDataMessage& a, SensorDataMessage& b) {
        using ::std::swap;
    ...
    SensorDataMessage::SensorDataMessage(const SensorDataMessage& other0) {
    ...
    SensorDataMessage& SensorDataMessage::operator=(const SensorDataMessage& other1) {
    ...
    void SensorDataMessage::printTo(std::ostream& out) const {
        using ::apache::thrift::to_string;
        out << "SensorDataMessage(";
